							...
							<span className={`imageShadow ${this.props.winner !== null && this.props.winner !== (index + 1) ? "faint" : ""}`}></span>
								<div className={`healthBar`}>
									<div style={{
										...
										backgroundColor: `${this.healthCalculator(this.props.player1Score, this.props.player2Score, this.props.player3Score, this.props[`player${index + 1}Score`]) < 40 ? `rgb(114, 12, 12)` : `seagreen`}`
									}}>
